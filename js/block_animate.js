if ($(window).width() > 1024) {
    (function () {
        ...
        mywebsite = (function () {
            ...
            mywebsite.prototype.animatePrograms = function () {
                var _this = this;
                return jQuery("#programs").waypoint(function () {
                    return new Animo({
                        el: jQuery("#programs h2"),
                        delay: 200,
                        duration: 500,
                        template: {
                            scale: [0, 1],
    ...
    /*        mywebsite.prototype.animateGlobal = function () {
            var _this = this;
            return jQuery("#home .go_global img").waypoint(function () {
                return new Animo({
                    el: jQuery("#home .go_global img"),
                    duration: 500,
                    delay: 2500,
                    gap: -85,
            ...
            mywebsite.prototype.animateAbout = function () {
                ...
                return jQuery("#about").waypoint(function () {
                    ...
                    return new Animo({
                        ...
                        el: jQuery("#about .right_block_effect"),
                        delay: 700,
                        duration: 600,
                        template: {
                            translateX: [50, 0, "%"],
                        ...
                        el: jQuery("#about .services_block"),
                        duration: 600,
                        delay: 900,
                        template: {
                            translateX: [50, 0, "%"],
            ...
            mywebsite.prototype.animateSkills = function () {
                return jQuery(".skill-bar").each(function () {
                    var el, progress;
                    el = jQuery(this);
            ...
            mywebsite.prototype.animateTestimonials = function () {
                var _this = this;
                return jQuery("#testimonials").waypoint(function () {

                    return new Animo({
                        el: jQuery("#testimonials .testimonials_block"),
                        delay: 200,
                        duration: 500,
                        template: {
                            scale: [0, 1],
            ...
            mywebsite.prototype.animateTeam = function () {
                var _this = this;
            ...
            mywebsite.prototype.animateNulla = function () {
                var _this = this;
                return jQuery("#nulla").waypoint(function () {

                    return new Animo({
                        el: jQuery("#nulla .nulla_block"),
                        delay: 200,
                        duration: 500,
                        template: {
                            scale: [0, 1],
            ...
            mywebsite.prototype.animatePortfolio = function () {
                var _this = this;
                return jQuery("#portfolio").waypoint(function () {

                    return new Animo({
                        el: jQuery("#portfolio h2"),
                        delay: 200,
                        duration: 500,
                        template: {
                            scale: [0, 1],
                        ...
                        el: jQuery("#portfolio .portfolio_effect"),
                        delay: 700,
                        duration: 800,
                        template: {
                            translateY: [20, 0, "%"],
